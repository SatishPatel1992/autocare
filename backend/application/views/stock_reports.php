<div class="row">
        ...
        <div class="col-lg-2">
            <div class="form-group form-material floating" data-plugin="formMaterial">
                <select id="report_type" class="form-control input-sm" id="report_type">
                    <option value="*">Select</option>
                    <option <?php if($_REQUEST['type'] == 'lwstsumm') { echo "selected"; } ?> value="lwstsumm">Low Stock Summary</option>
                    <option <?php if($_REQUEST['type'] == 'stsumm') { echo "selected"; } ?>   value="stsumm">Stock Summary</option>
                    <option <?php if($_REQUEST['type'] == 'itmsalsumm') { echo "selected"; } ?> value="itmsalsumm">Item Sales Summary</option>
                    <option <?php if($_REQUEST['type'] == 'itmpursumm') { echo "selected"; } ?> value="itmpursumm">Item Purchase Summary</option>
                </select>
                <label class="floating-label">Report Type</label><br>
            </div>
        </div>
        <div class="col-lg-2">
